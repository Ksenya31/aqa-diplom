...
public class NewsPageTest extends BaseTest {
    ...
    //Раздел"News"  (просмотр новостей, переход в поиск, редактирование)
    @Test
    @DisplayName("Фильтрация нововстей Filter news ")
    ...
    @Test
    @DisplayName("Разворачиване описания новости в одном блоке")
